from insights.client.auto_config import apply_network_configuration
...
def test_sat_branch_info_called(connection):
    ...
    apply_network_configuration(config, 'test.com:443/redhat_access', 'some_cert', None, True, False)
...
def test_rhsm_branch_info_not_called(connection):
    ...
    '''
    config = Mock(base_url=None, upload_url=None, legacy_upload=False)
    apply_network_configuration(config, 'cert-api.access.redhat.com', None, None, False, False)
